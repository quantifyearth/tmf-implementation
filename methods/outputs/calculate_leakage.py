...
def generate_leakage(
    ...
    if dump_dir is not None:
        ...
        plot_carbon_trajectories(axis, 'Carbon stock (All Matches Treatment)', 1, l_tot, project_start)
        plot_carbon_trajectories(axis, 'Carbon stock (All Matches Control)', 2, scvt, project_start)
        plot_carbon_stock(axis, project, c_tot, project_start)

        os.makedirs(dump_dir, exist_ok=True)
        out_path = os.path.join(dump_dir, os.path.splitext(pairs)[0] + "-leakage-carbon-stock.png")
